...
public class PacketKontraptionGuiButtonPress implements IMekanismPacket {
    ...
    public PacketKontraptionGuiButtonPress(ClickedGeneratorsTileButton buttonClicked, BlockPos tilePosition) {
        this(buttonClicked, tilePosition, 0);
    }

    public PacketKontraptionGuiButtonPress(ClickedGeneratorsTileButton buttonClicked, BlockPos tilePosition, int extra) {
    ...
    public static PacketKontraptionGuiButtonPress decode(FriendlyByteBuf buffer) {
